 ...
 *
 */
public class ProgramGraphStateEnumerator implements StateEnumerator {

	protected ProgramGraph pg;
	 ...
	 */
	public ProgramGraphStateEnumerator(ProgramGraph pg, Set<ActionDef> actionDefs, Set<ConditionDef> conditionDefs) {
		this.pg = pg;
	...
	class ProgramState implements EnumeratedState {
		 ...
		 *            An evaluation of all variables.
		 */
		public ProgramState(Location location, Map<String, Object> eval) {
			super();
		...
		public EnumeratedState nextState(TransitionInput input) {
			PGTransition tran = ((MyTransitionInput) input).tran;
		...
		public String toString() {
			...
			return "[location=" + location.getLabel() + ", eval=" + e + "]";
		}
