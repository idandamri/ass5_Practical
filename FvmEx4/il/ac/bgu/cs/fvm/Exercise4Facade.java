 ...
 */
public interface Exercise4Facade {
    ...
    TransitionSystem product(TransitionSystem ts, Automaton aut);

	Automaton GNBA2NBA(MultiColorAutomaton mulAut);

	Automaton LTL2BA(Ltl ltl);
